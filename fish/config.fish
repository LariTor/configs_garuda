...
## NVIM como default visual y editor para que lo lance ranger
set -gx EDITOR nvim
set -gx VISUAL nvim
alias vi "nvim"
...
#set -gx MAMBA_ROOT_PREFIX "/home/lari/micromamba"
#$MAMBA_EXE shell hook --shell fish --prefix $MAMBA_ROOT_PREFIX | source
# <<< mamba initialize <<<

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
if test -f /home/lari/miniconda3/bin/conda
    eval /home/lari/miniconda3/bin/conda "shell.fish" "hook" $argv | source
end
# <<< conda initialize <<<

#ESP32 RUST toolchain
set -gx LIBCLANG_PATH '/home/lari/.rustup/toolchains/esp/xtensa-esp32-elf-clang/esp-16.0.0-20230516/esp-clang/lib'
